...
function AdminEventCard({eventID}) {
    ...
    return (
        <div className='dark:bg-la-gray-med bg-la-light-gray-extra-lightest dark:text-ivory text-la-gray-med w-full max-w-[1400px] rounded mx-2 my-2 p-2 '>
            {updateOpen && (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg: lg:grid-cols-3 xl:grid-cols-5 gap-2'>
                <div className='border-2 border-la-gray-med dark:border-la-light-gray-med p-2 rounded-sm'>
                ...
                <div className='border-2 border-la-gray-med dark:border-la-light-gray-med p-2 rounded-sm'>
                    <p><span className='font-semibold'>Name: </span>
                        <button 
                            ...
                            className='dark:hover:bg-la-gray-dark hover:bg-la-light-gray hover:p-2'
                        >
                            {name}
                        </button>
                    </p>
            ...
            <div className='my-4 border-2 border-la-gray-med dark:border-la-light-gray-med p-2 rounded-sm'>
                <div className='mb-4'>
                    <p><span className='font-semibold'>Description: </span>
                        <button 
                            onClick={()=>handleEventUpdateClick('description')}    
                            className='dark:hover:bg-la-gray-dark hover:bg-la-light-gray hover:p-1'
                        >
                            {description}
                        </button>
                    </p>
                ...
                <div>
                    <p className='flex gap-4'><span className='font-semibold'>Image: </span>
                        <button 
                            ...
                            className='dark:hover:bg-la-gray-dark hover:bg-la-light-gray p-1'
                        >
            ...
            <hr className='h-[2px] border-0 bg-transparent border-t-2 border-la-gray-light w-full my-8' />
            {/* venue */}
            <div className='my-4 font-semibold text-2xl'>
            ...
            <div className='border-2 border-la-gray-med dark:border-la-light-gray-med p-2 rounded-sm my-2'>
