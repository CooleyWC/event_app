...
function CreateEventForm({attrSelect, onSubmitUpdate, onUpdateCancel}) {
    ...
    return (
        ...
        <div className='bg-la-gray-dark p-4'>
            ...
            <div className='pt-4 flex flex-row gap-2'> 
                <button onClick={()=>onSubmitUpdate(textInput)} className='border border-white p-2 hover:bg-la-blue hover:text-white'>Submit Update</button>
                <button onClick={onUpdateCancel} className='border border-white hover:bg-red-700 p-2'>Cancel {attrSelect} Update</button>
            </div>
        </div>
