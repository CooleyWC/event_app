            ...
            <div className='pt-20 lg:pt-0 px-4 lg:px-8 dark:bg-warm-blackboard-dark h-full min-h-screen dark:text-ivory flex flex-col gap-6'>
                ...
                {hasTicket ? (
                    <>
                        ...
                        <button className='max-w-56 bg-transparent font-bold py-2 px-4 border-solid rounded border-red-600 border hover:bg-red-700 hover:text-white transition ease-in-out' onClick={onTicketDelete}>Cancel</button>
                    </>
                ):(
                    <button className='min-w-56 min-h-20 text-2xl text-white bg-la-blue font-bold py-2 px-4 border-solid rounded hover:bg-la-blue-dark transition ease-in-out' onClick={onProcessTicket}>Get Ticket</button>
                )}
