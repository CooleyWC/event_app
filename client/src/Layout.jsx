...
function Layout() {
    ...
    return (
        <>
        <div className='mt-18 min-h-screen bg-ivory dark:bg-warm-blackboard-dark text-slate-800'>
            {/* hero */}
            ...
            {/* info cards */}
            <div className='bg-warm-blackboard-very-light mx-auto max-w-[1600px] w-full mt-14'>
                ...
                <div className='bg-warm-blackboard-light w-full flex justify-center py-4'>
                    <button onClick={handleGetStartedClick} className='tracking-wide text-xl bg-warm-ox-red text-white font-semibold py-3 px-5 mr-2 border-solid rounded  hover:bg-warm-ox-red-med hover:text-white transition ease-in-out'>Get Started</button>
                </div>
            </div>
            {/* review carousel */}
            <div className='bg-warm-blackboard mx-auto max-w-[1600px] w-full mt-10 mb-10'>
                <div>
            ...
            {/* footer */}
            <footer className='bg-warm-blackboard-very-dark text-white flex flex-col sm:flex-row justify-between px-10'>
                <div className='my-8'>
